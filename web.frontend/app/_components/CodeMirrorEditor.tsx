...
const codeBlockSingle = Decoration.line({
  attributes: {
    class: "cm-codeblock-line cm-codeblock-start cm-codeblock-end",
  },
});
  ...
  return ViewPlugin.fromClass(
    class {
      ...
      buildDecorations(view: EditorView): DecorationSet {
        ...
        const tree = syntaxTree(view.state as any);
        ...
        // CM6 types for DecorationSet vs RangeSet can diverge across versions.
        // Cast here keeps runtime behavior identical while satisfying TS.
        return builder.finish() as unknown as DecorationSet;
      }
    },
    {
    ...
    const obsidianUITheme = EditorView.theme(
      {
        ...
        ".cm-selectionBackground, ::selection": {
          backgroundColor:
            "color-mix(in srgb, var(--markdown-text) 50%, transparent) !important",
        },
        "&.cm-focused .cm-selectionBackground": {
          backgroundColor:
            "color-mix(in srgb, var(--markdown-text) 70%, transparent) !important",
        },
